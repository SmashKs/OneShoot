 ...
 * vary data.
 */
abstract class BaseUseCase<T, R : RequestValues>(
     ...
     * There is a [subscribeOn] for fetching the data from the [smash.ks.com.domain.repositories.DataRepository] works on the new thread
